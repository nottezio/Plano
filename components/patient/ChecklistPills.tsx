...
export function ChecklistPills({
  ...
  return (
    <section aria-label="Checklist hari ini" className="border-b border-border px-4 py-2">
        ...
        {visible.map((item) => {
          ...
          return (
            <button
              ...
              className={[
                'flex min-h-tap shrink-0 items-center gap-1.5 rounded-full border px-3 text-xs',
                done
